...
import { getAreaPerToken } from "@/services/supporter/getAreaPerToken";
...
export async function BurnedTokens({ address, t }: Props) {
  ...
  const soilPerToken = await getAreaPerToken();
        ...
        <div className="w-full lg:w-[50%]">
          ...
          <div className="flex flex-wrap justify-around">
            <ImpactItem
              ...
              }).format(burnedTokens * carbonPerToken)}
              suffix="g"
            />
            <ImpactItem
              label={t("bio")}
              ...
              }).format(burnedTokens * bioPerToken)}
            />
            <ImpactItem
              label={t("trees")}
              value={Intl.NumberFormat("pt-BR", {
